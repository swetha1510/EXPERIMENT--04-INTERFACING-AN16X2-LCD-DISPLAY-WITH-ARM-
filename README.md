...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
   ...
   Lcd_cursor(&lcd, 0,0);
   Lcd_string(&lcd," 212222100053");
   Lcd_cursor(&lcd, 1,0);
   Lcd_string(&lcd,"SWETHA P");
...
![pqm ex04](https://user-images.githubusercontent.com/120623583/234840020-7313ccc7-af28-4a24-b6cf-1b6b72c41ad0.png)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE):
 
 ![pqmex04(2)](https://user-images.githubusercontent.com/120623583/234840077-89328ce7-d826-4e66-9942-8ee2247e326a.png)
